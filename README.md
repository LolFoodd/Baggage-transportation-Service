...
- услуги отслеживания груза: некоторые службы перевозки предоставляют возможность отслеживать статус и местоположение груза в режиме реального времени для удобства клиентов.
  ...
  ![](Aspose.Words.4f218b5b-13eb-4fca-b7e9-8829e9d1576c.001.png)
...
- подготовка отчета (сотрудник вносит информацию о показателях в систему, формируется отчет).
  ...
  ![](Aspose.Words.4f218b5b-13eb-4fca-b7e9-8829e9d1576c.002.png)
...
1) Составление расписания доставки груза (маршрут документа представлен на рисунке 1.3).
   ...
   ![](Aspose.Words.4f218b5b-13eb-4fca-b7e9-8829e9d1576c.003.png)
...
1) Заявка на закупку транспортного оборудования (маршрут документа представлен на рисунке 1.4).
   ...
   ![](Aspose.Words.4f218b5b-13eb-4fca-b7e9-8829e9d1576c.004.png)
...
1) Запрос на страхование груза в страховую компанию (маршрут документа представлен на рисунке 1.5).
   ...
   ![](Aspose.Words.4f218b5b-13eb-4fca-b7e9-8829e9d1576c.005.png)
...
1) Заявка на перевозку груза (маршрут документа представлен на рисунке 1.6).
   ...
   ![](Aspose.Words.4f218b5b-13eb-4fca-b7e9-8829e9d1576c.006.png)
...
- «один-ко-многим»: клиенты (clients) – опись вещей (things).
  ...
  ![](Aspose.Words.4f218b5b-13eb-4fca-b7e9-8829e9d1576c.007.jpeg)Рисунок 2.1 – ER-диаграмма базы данных
...
- сотрудник.
  ...
  ![](Aspose.Words.4f218b5b-13eb-4fca-b7e9-8829e9d1576c.008.png)

  Рисунок 3.1 – Страница-список «договоры»

  ![](Aspose.Words.4f218b5b-13eb-4fca-b7e9-8829e9d1576c.009.png)

  Рисунок 3.2 – Страница-список «клиенты»

  ![](Aspose.Words.4f218b5b-13eb-4fca-b7e9-8829e9d1576c.010.png)

  Рисунок 3.3 – Страница-список «описи вещей»

  ![](Aspose.Words.4f218b5b-13eb-4fca-b7e9-8829e9d1576c.011.png)

  Рисунок 3.4 – Страница-список «отчеты»

  ![](Aspose.Words.4f218b5b-13eb-4fca-b7e9-8829e9d1576c.012.png)

  Рисунок 3.5 – Страница-список «сотрудники»

  На рисунках 3.6 – 3.10 показаны страницы карточки для всех объектов БД.

  ![](Aspose.Words.4f218b5b-13eb-4fca-b7e9-8829e9d1576c.013.png)

  Рисунок 3.6 – Страница-карточка договора

  ![](Aspose.Words.4f218b5b-13eb-4fca-b7e9-8829e9d1576c.014.png)

  Рисунок 3.7 – Страница-карточка клиента

  ![](Aspose.Words.4f218b5b-13eb-4fca-b7e9-8829e9d1576c.015.png)

  Рисунок 3.8 – Страница-карточка описи вещей

  ![](Aspose.Words.4f218b5b-13eb-4fca-b7e9-8829e9d1576c.016.png)

  Рисунок 3.9 – Страница-карточка отчета

  ![](Aspose.Words.4f218b5b-13eb-4fca-b7e9-8829e9d1576c.017.png)
  ...
  ![](Aspose.Words.4f218b5b-13eb-4fca-b7e9-8829e9d1576c.018.png)

  Рисунок 3.11 – Страница с формой ввода нового договора

  ![](Aspose.Words.4f218b5b-13eb-4fca-b7e9-8829e9d1576c.019.png)

  Рисунок 3.12 – Страница с формой ввода нового клиента

  ![](Aspose.Words.4f218b5b-13eb-4fca-b7e9-8829e9d1576c.020.png)

  Рисунок 3.13 – Страница с формой ввода новой описи вещей

  ![](Aspose.Words.4f218b5b-13eb-4fca-b7e9-8829e9d1576c.021.png)

  Рисунок 3.14 – Страница с формой ввода нового сотрудника

  ![](Aspose.Words.4f218b5b-13eb-4fca-b7e9-8829e9d1576c.022.png)
...
![](Aspose.Words.4f218b5b-13eb-4fca-b7e9-8829e9d1576c.025.png)
...
![](Aspose.Words.4f218b5b-13eb-4fca-b7e9-8829e9d1576c.026.png)
...
![](Aspose.Words.4f218b5b-13eb-4fca-b7e9-8829e9d1576c.027.png)

Рисунок 3.20 – Форма выставления параметров фильтрации для генерации табличного документа

![](Aspose.Words.4f218b5b-13eb-4fca-b7e9-8829e9d1576c.028.png)
...
![](Aspose.Words.4f218b5b-13eb-4fca-b7e9-8829e9d1576c.029.png)

Рисунок 3.22 – Форма для редактирования договора

![](Aspose.Words.4f218b5b-13eb-4fca-b7e9-8829e9d1576c.030.png)

Рисунок 3.23 – Форма для редактирования клиента

![](Aspose.Words.4f218b5b-13eb-4fca-b7e9-8829e9d1576c.031.png)

Рисунок 3.24 – Форма для редактирования описи вещей

![](Aspose.Words.4f218b5b-13eb-4fca-b7e9-8829e9d1576c.032.png)

Рисунок 3.25 – Форма для редактирования отчета

![](Aspose.Words.4f218b5b-13eb-4fca-b7e9-8829e9d1576c.033.png)
...
![](Aspose.Words.4f218b5b-13eb-4fca-b7e9-8829e9d1576c.034.png)
...
![](Aspose.Words.4f218b5b-13eb-4fca-b7e9-8829e9d1576c.035.png)
...
![](Aspose.Words.4f218b5b-13eb-4fca-b7e9-8829e9d1576c.036.png)
